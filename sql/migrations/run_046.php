<?php
/**
 * Migration 046: Update solution_code for task #12 Rechnung III
 * to conventional while loop without walrus/break.
 */
...
try {
    ...
    echo "Running Migration 046: update solution code for #12...\n";
...
PY;
    ...
    echo "\n✅ Migration 046: Success!\n";
    $conn->close();
} catch (Exception $e) {
    echo "❌ Migration 046 failed: " . $e->getMessage() . "\n";
    exit(1);
}
