...
try {
    ...
    $sql = '
        SELECT
            ...
            COALESCE(ua_user.is_rework, ua_team.is_rework, 0) AS is_rework,
    ...
    $user['raw_status'] = $rawStatus;
    $user['is_late'] = $displayStatus['is_late'] ?? false;
